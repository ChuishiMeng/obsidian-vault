...
## [2026-04-17] lint | 发现 index.md 缺失约19个 sources 条目（科研论文 p10/p11/p13/p15/p23/p36/p38/p39 + 近期文章），raw/ 目录为空。总页面117，结构完整但索引需同步。建议下次 cron 编译时自动补全。

---

## [2026-04-17 03:00] 增量编译

- **新增页面**: 1
  - `投资/估值记录/2026-04-16_螺丝钉估值.md`
- **编译内容**:
  - sources: +1（螺丝钉估值 2026-04-16）
- **摘要**: 大盘3.9星，低估区域适合定投。常规每日估值数据记录。
- **编译耗时**: ~5s

## [2026-04-18 02:00] lint | 深夜知识库审查

- **状态**: 基本健康
- **问题**: 
  1. concepts/ 内部双向链接不完整（vibe-coding ↔ ai-coding）
  2. 4月17-18日无新增知识入库
  3. investment 主题缺少相关实体页
- **统计**: sources 57, concepts 23, entities 16, topics 18, 总计 128 页面
- **行动**: 下次 cron 补全交叉引用
